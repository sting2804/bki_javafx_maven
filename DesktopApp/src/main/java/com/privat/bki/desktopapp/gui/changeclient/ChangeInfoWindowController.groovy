 ...
 * @author sting
 */
class ChangeInfoWindowController implements Initializable {

    @FXML
    Button applyButton
    @FXML
    ComboBox<String> bankCodeComboBox
    @FXML
    ComboBox<String> currencyCodeComboBox
    @FXML
    ...
    @FXML
    void changeInfoOnClick(ActionEvent event) {
    ...
    void setLoanInfo(LoanInfo searchInfo) {
    ...
    void setBankMap(Map<String, String> bankMap) {
