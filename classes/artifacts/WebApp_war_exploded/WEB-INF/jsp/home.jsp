...
<nav class="navbar navbar-inverse navbar-static-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">БКИ</a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                ...
                <li>
                    <a href="loan_info.jsp">Інформація про кредити</a>
                </li>
                <li>
                    <a href="recommendations.jsp">Рекомендації щодо кредитування</a>
                </li>
                <li>
                    <a href="about.jsp">Контакти</a>
                </li>
            </ul>
        </div>
        <!--/.nav-collapse -->
...
<div class="container theme-showcase" role="main">
    <div class="jumbotron">
        <h1>Чим займається бюро кредитних історій?</h1>

        <p>Опис базового ф-ционалу і можливостей мого БКИ.</p>
    </div>
</div>
<div class="section">
    <div class="container">
...
<footer class="section section-primary">
    <div class="container">
        <div class="row">
            <div class="col-sm-4"><h1>Footer header</h1>
